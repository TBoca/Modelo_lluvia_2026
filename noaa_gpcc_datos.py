...
def guardar_muestra_datos_publicos_csv(ruta_csv="muestra_noaa_psl_pampeana_2023.csv"):
...
def generar_datos_ejemplo_pampeana(ruta_csv="precipitacion_pampeana_ejemplo.csv"):
...
def guardar_resumen_csv(ruta_csv="resumen_noaa_gpcc_recursos.csv"):
