...
DEFAULT_REFERENCES = [
    "datos/datos_chirps_mensuales_todas_localidades.csv",
    "datos/datos_gpcc_mensuales_todas_localidades.csv",
    "datos/datos_nasa_mensuales_todas_localidades.csv",
    "datos/datos_noaa_psl_mensuales_todas_localidades.csv",
    "datos/datos_ndvi_modis_mensual_todas_localidades.csv",
]
...
def generar_indices_periodo(
    ...
    salida_long: str = "datos/datos_indices_climaticos_mensuales_long.csv",
    salida_wide: str = "datos/datos_indices_climaticos_mensuales.csv",
    incluir_mei: bool = True,
    carpeta_base: Path | None = None,
) -> tuple[pd.DataFrame, pd.DataFrame]:
    base = carpeta_base or BASE_DIR
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--salida-long",
        type=str,
        default="datos/datos_indices_climaticos_mensuales_long.csv",
        help="CSV de salida en formato largo",
    )
    parser.add_argument(
        "--salida-wide",
        type=str,
        default="datos/datos_indices_climaticos_mensuales.csv",
